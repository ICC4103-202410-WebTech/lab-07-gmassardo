...
if user
  john_doe_posts = user.posts
  
else
  puts "User 'John Doe' not found."
end
```
...
users_with_tag_1 = User.joins(posts: { tags: :posts_tags }).where(tags: { name: "Tag 1" })
